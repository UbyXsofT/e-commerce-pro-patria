		...
		<div>
			...
			>
				...
				>
					...
					<Grid item>
						<Typography>
							{password.length === 0 ? "" : `${length.detail}`}
						</Typography>
					</Grid>
				</Grid>
				<Grid
				...
				>
					...
					<Grid item>
						<Typography>
							{password.length === 0 ? "" : `${lettereNumeri.detail}`}
						</Typography>
					</Grid>
				</Grid>
				<Grid
				...
				>
					...
					<Grid item>
						<Typography>
							{password.length === 0 ? "" : `${maiuscoloMinuscolo.detail}`}
						</Typography>
					</Grid>
				</Grid>
				<Grid
				...
				>
					...
					<Grid item>
						<Typography>
							{password.length === 0 ? "" : `${caratteriSpeciali.detail}`}
						</Typography>
					</Grid>
				</Grid>
			</Grid>
