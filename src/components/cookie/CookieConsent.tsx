	...
	const info_Txt = manage ? (
		...
		<React.Fragment>
			<Typography
				...
				gutterBottom
			>
				Utilizziamo i cookie per aiutarti a navigare in modo efficiente ed
			...
			<Typography
				...
				paragraph={true}
			>
				I cookie classificati come "Necessari" vengono memorizzati nel browser
				in quanto sono essenziali per abilitare le funzionalità di base del
				sito.
			</Typography>
		</React.Fragment>
	);
