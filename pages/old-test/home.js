	...
	return (
		<>
			<Box sx={{display: "flex"}}>
				...
				>
					<DrawerHeader />
					<Typography paragraph>Lorem Ipsum 1</Typography>
					<Typography paragraph>Lorem Ipsum 2 Why do we use it?</Typography>
					<Typography paragraph>Lorem Ipsum 3 readable content</Typography>
