		...
		<ThemeProvider theme={theme}>
			...
			>
				...
				<FormControlLabel
					control={
						<Switch
							checked={checkedCookie_Tecnici}
							onChange={handleChange_Cookie_Tecnici}
						/>
					}
					label='Consenti'
				/>
				...
				<FormControlLabel
					control={
						<Switch
							checked={checkedCookie_Analisi}
							onChange={handleChange_Cookie_Analisi}
						/>
					}
					label='Consenti'
				/>
				...
				<FormControlLabel
					control={
						<Switch
							checked={checkedCookie_Personali}
							onChange={handleChange_Cookie_Personali}
						/>
					}
					label='Consenti'
				/>
