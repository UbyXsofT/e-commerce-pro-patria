...
import {Container, Grid, Typography, TextField, Button, Checkbox, FormControlLabel, FormControl, FormHelperText, Link, Fade, AppBar, Toolbar, Collapse, Switch, Box, List, ListItem, ListItemText} from "@mui/material";
...
const TerminiCondizioni = ({setLoading}) => {
			...
			>
				...
				<Box sx={{marginLeft: 2}}>
					<List>
						...
						<ListItem>
							<ListItemText primary={`1.2 Uso Responsabile: L'utente si impegna a utilizzare il sito web in modo responsabile e a rispettare tutte le leggi e i regolamenti applicabili.`} />
						</ListItem>
				...
				<Box sx={{marginLeft: 2}}>
					<List>
						...
						<ListItem>
							<ListItemText primary={`2.3 Accesso e Sospensione: Ci riserviamo il diritto di sospendere o disattivare un account utente in caso di violazione delle Condizioni Generali o di qualsiasi comportamento inappropriato.`} />
						</ListItem>
					</List>
				</Box>
				...
				<Box sx={{marginLeft: 2}}>
					<List>
						<ListItem>
							<ListItemText primary={`3.1 Disponibilità dei Prodotti: Tutti i prodotti offerti sul sito sono soggetti a disponibilità. Ci riserviamo il diritto di modificare o interrompere i prodotti senza preavviso.`} />
						</ListItem>

						<ListItem>
							<ListItemText primary={`3.2 Prezzi e Pagamenti: I prezzi dei prodotti sono indicati in Euro e sono soggetti a modifiche senza preavviso. Il pagamento dei prodotti avviene attraverso metodi di pagamento sicuri e autorizzati.`} />
						</ListItem>
						<ListItem>
							<ListItemText primary={`3.3 Spedizioni: Effettuiamo le spedizioni dei prodotti entro i tempi indicati sul sito. I costi di spedizione possono variare in base alla destinazione e alla modalità di spedizione scelta.`} />
						</ListItem>

						<ListItem>
							<ListItemText primary={`3.4 Politica di Reso e Rimborso: Per la nostra politica di reso e rimborso, ti invitiamo a consultare la pagina dedicata sul nostro sito.`} />
						</ListItem>
					</List>
				</Box>
				...
				<Box sx={{marginLeft: 2}}>
					<List>
						<ListItem>
							<ListItemText primary={`4.1 Non forniamo garanzie esplicite o implicite riguardo ai prodotti offerti sul sito, fatta eccezione per quelle espressamente dichiarate.`} />
						</ListItem>
				...
				<Box sx={{marginLeft: 2}}>
					<List>
						<ListItem>
							<ListItemText primary={`5.1 Ci riserviamo il diritto di modificare le presenti Condizioni Generali di Uso e Vendita in qualsiasi momento senza preavviso. Le modifiche saranno effettive dalla data di pubblicazione sul sito.`} />
						</ListItem>
					</List>
				</Box>
